...
public class ModSettings {
    public static boolean blisseyEspEnabled = false;
    ...
    public static int blisseyR = 255;
    public static int blisseyG = 50;
    public static int blisseyB = 200;

    public static int shinyR = 255;
    public static int shinyG = 200;
    public static int shinyB = 0;

    public static int ivR = 0;
    public static int ivG = 255;
    public static int ivB = 255;

    public static int berryR = 200;
    public static int berryG = 100;
    public static int berryB = 255;
    ...
    public static int xrayCarmotR = 230;
    public static int xrayCarmotG = 0;
    public static int xrayCarmotB = 90;
    ...
    public static int xrayUnobtainiumR = 200;
    public static int xrayUnobtainiumG = 200;
    public static int xrayUnobtainiumB = 200;
